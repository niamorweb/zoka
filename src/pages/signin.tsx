        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Sharing memories through images has never been easier.
                This tool has revolutionized how I connect with friends and
                family, making every moment unforgettable.&rdquo;
              </p>
